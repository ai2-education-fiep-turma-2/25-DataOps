...
if __name__ == "__main__":
    ...
    tracking_uri="http://localhost:8893"
    mlflowClient = mlflow.tracking.MlflowClient(tracking_uri)
    
    #experiment_to_run=mlflowClient.get_experiment_by_name("t1")
    ...
    print(experiments)
    print(experiments[1].experiment_id)
    
    run = client.create_run(experiments[1].experiment_id) # returns mlflow.entities.Run
    ...
    #client.sklearn.log_model(lr, "model")
